    ...
    return (
        <div className="flex flex-col min-h-screen bg-gray-50 p-4">
            ...
            <div className="flex flex-1 justify-center items-center">
                <div className="card w-full max-w-md bg-slate-50 shadow-xl">
                    <div className="card-body">
                        <h2 className="text-center text-2xl font-bold text-black">Login</h2>
                        {/* Demo credentials note */}
                        <p className="text-sm text-gray-600 mb-3 text-center">Demo credentials are listed in the README.</p>
                        ...
                        {/* Demo credentials moved to README. Refer to README for test accounts. */}
                    </div>
                </div>
            </div>
